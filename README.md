...
2. Get a free Groq API key from **console.groq.com** (starts with `gsk_`)
3. Paste it in the sidebar under **🔑 Groq API Key (BYOK)**
4. Upload your PDF(s) and start studying!
